...
public enum Task {
    ...
    SHI_LIAN_DONG(ShiLianDong.class, 3, 3),
    ...
    LIAN_MENG_QING_QIU_JUAN_KA(LianMeng.class, Task.DO_INFINITY, Task.DO_INFINITY, 24 * 60 * 60),
    LIAN_MENG_JUAN_KA(LianMeng.class, Task.DO_INFINITY, Task.DO_INFINITY, 24 * 60 * 60),
